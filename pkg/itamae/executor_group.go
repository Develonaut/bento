...
func (i *Itamae) executeGroup(ctx context.Context, def *neta.Definition, execCtx *executionContext, result *Result) error {
...
func (i *Itamae) executeGroupNodes(
	ctx context.Context,
	def *neta.Definition,
...
func (i *Itamae) logGroupStart(def *neta.Definition, execCtx *executionContext) {
...
func (i *Itamae) handleEmptyGroup(def *neta.Definition) error {
...
func (i *Itamae) buildAndValidateGraph(def *neta.Definition, start time.Time) (*graph, error) {
...
func (i *Itamae) buildGraphWithErrorHandling(def *neta.Definition, start time.Time) (*graph, error) {
...
func (i *Itamae) validateNoCycles(g *graph, def *neta.Definition, start time.Time) error {
	if g.hasCycle() {
...
func (i *Itamae) notifyGraphError(nodeID string, start time.Time, err error) {
	if i.messenger != nil {
...
func (i *Itamae) executeGroupGraph(
	ctx context.Context,
	def *neta.Definition,
	g *graph,
	execCtx *executionContext,
...
func (i *Itamae) logGroupComplete(def *neta.Definition, execCtx *executionContext, duration time.Duration) {
	i.notifyProgress(def.ID, "completed")
