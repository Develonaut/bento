...
The storage layer for managing .bento.yaml files and execution history. Like stacked boxes holding organized meals, Jubako manages your workflow files and tracks execution records.
...
**Dependencies**: `neta`, `itamae`, `pantry`, `jubako`
...
Application layer:
└── omise → neta, itamae, pantry, jubako
```
...
- **Jubako** = Stacked containers for organized storage
