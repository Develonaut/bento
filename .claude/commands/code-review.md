...
1. **Guilliman** (`.claude/agents/Guilliman.md`) - Go Standards Guardian
2. **Voorhees** (`.claude/agents/Voorhees.md`) - Complexity Slasher
3. **Karen** (`.claude/agents/Karen.md`) - Bento Box Enforcer
